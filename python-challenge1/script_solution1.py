...
def decodifica(lista_cifradocodigo, chave_k):
    ...
    Args:
        ...
        chave_k (int): chave para decodificação
...
def main():
    ...
    chave_k = int(input('Digite a chave (número inteiro): '))
    ...
    if opcao == '0':
        ...
        print(f'Frase codificada: {textocifrado}')
        ...
        print(f'Frase decodificada: {textoplano}')
